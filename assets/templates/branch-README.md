...
**sensitivity: << open | private | sealed >>** · **whose business: << the owner's · someone else's, named >>**

<< One sentence, in the owner's words: what this area of life is. >>
...
<< Only if there are any. Most branches have none, and that is correct — do not invent a rule to fill the section.
   A branch rule may add or tighten. It may never contradict the constitution; that would be an amendment, and amendments are owner decisions logged in DECISIONS.md. >>

## Map

<< Once this branch passes about five files: [INDEX.md](INDEX.md) — read it instead of opening folders. Delete this line until then. >>
